"""Модуль, реализующий класс FileManager (чтение и запись данных в файл в формате csv)"""
import csv
...
class FileManager:
    ...
    Данный класс реализует чтение заметок из файла и запись в файл в формате csv.
        ...
        2. ile_read: чтение файла и сохранение данных в записную книжку с заметками.
